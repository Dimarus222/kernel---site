...
KERNEL_DATA.addNote({
    ...
    content: function() {
        ...
        return [
            ...
            App.createCodeBlock(
                '╔═══════╦═════╦══════════════════════════════════════════════════╗\n║ Флаг  ║ Бит ║ Назначение                                       ║\n╠═══════╬═════╬══════════════════════════════════════════════════╣\n║ CWR   ║  8  ║ Congestion Window Reduced — окно перегрузки     ║\n║ ECE   ║  7  ║ ECN-Echo — уведомление о перегрузке             ║\n║ URG   ║  6  ║ Urgent — срочные данные (используется редко)    ║\n║ ACK   ║  5  ║ Acknowledge — подтверждение получения           ║\n║ PSH   ║  4  ║ Push — передать данные приложению немедленно    ║\n║ RST   ║  3  ║ Reset — принудительный разрыв соединения       ║\n║ SYN   ║  2  ║ Synchronize — запрос на установку соединения    ║\n║ FIN   ║  1  ║ Finish — завершение передачи данных             ║\n╚═══════╩═════╩══════════════════════════════════════════════════╝',
                'plaintext'
            ),
